            ...
            <div className="App">
                ...
                <header className="Project">
                    ...
                    <ol class="description">
                        <li>
                            <Collapsible title="Save Game System">
                                <p>
                        ...
                        <li>
                            <Collapsible title="Ability to move placed object">
                                <p>
                        ...
                        <li>
                            <Collapsible title="More Placeables">
                                <p>
                        ...
                        <li>
                            <Collapsible title="Place Item on top of other">
                                <p>
                        ...
                        <li>
                            <Collapsible title="Colour Object">
                                <p>
                        ...
                        <li>
                            <Collapsible title="Better user experience: keybind/layout">
                                <p>
                        ...
                        <li>
                            <Collapsible title="Better user experience: Tutorial">
                                <p>
                    ...
                    <div class="description">
                        <Collapsible title="Implementation">
                            ...
                            <Collapsible title="Move Object UI">
                                <p>
                            ...
                            <Collapsible title="Save Game UI">
                            ...
                            <Collapsible title="Placeable UI/preview">
                            ...
                            <Collapsible title="Place On Top">
                                <p>
